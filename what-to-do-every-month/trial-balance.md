...
関連: [`what-to-do-every-month.md`](./what-to-do-every-month.md)
...
- 仕訳ミスや未記帳を修正し、差異を解消
- 原因不明は「仮勘定」「現金過不足」等で一時処理し、ToDoとして翌月に引継ぎ
...
- 月次全体フロー: [`what-to-do-every-month.md`](./what-to-do-every-month.md)
- 勘定科目と経費判定: [`../reference/chart-of-accounts.md`](../reference/chart-of-accounts.md)
- 実務での仕訳パターン: [`../basics/journal-entries.md`](../basics/journal-entries.md)
